...
const Background: React.FC = () => {
  return (
    <div className="fixed inset-0 z-0 pointer-events-none theme-transition overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[var(--bg-app)] transition-colors duration-700" />
      
      {/* Playful Soft Blurs */}
      <div className="absolute top-[-10%] left-[-10%] w-[50%] h-[50%] bg-[var(--primary)]/5 blur-[120px] rounded-full animate-pulse" />
      <div className="absolute bottom-[-5%] right-[-5%] w-[40%] h-[40%] bg-[var(--secondary)]/5 blur-[100px] rounded-full animate-pulse" style={{ animationDelay: '2s' }} />
      <div className="absolute top-[30%] right-[-10%] w-[30%] h-[30%] bg-[var(--highlight)]/5 blur-[100px] rounded-full animate-pulse" style={{ animationDelay: '4s' }} />
