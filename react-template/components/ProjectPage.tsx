...
export default function ProjectPage({ 
  project, onVoiceToggle, onSendMessage, onInvitePeople, isRimaTyping 
}: ProjectPageProps) {
    ...
    <div className="w-full max-w-2xl h-full flex flex-col overflow-hidden relative">
      ...
      <div className="flex-1 overflow-y-auto px-6 py-8 space-y-6 scrollbar-hide pb-40">
        ...
        {project.messages.map((msg, idx) => {
            ...
            const showAvatar = !isSelf && (idx === 0 || project.messages[idx - 1].sender !== msg.sender);
            ...
            return (
              ...
              >
                  ...
                  <div className={`flex flex-col max-w-[85%] ${isSelf ? 'items-end' : 'items-start'}`}>
                      ...
                      <div className={`relative px-5 py-4 shadow-sm transition-all ${
                        isRima 
